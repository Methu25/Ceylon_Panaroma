      ...
      <div id="promoCarousel" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="images/promotion/Promotion01.jpg" class="d-block w-100" alt="Promo 1">
          </div>
          <div class="carousel-item">
            <img src="images/promotion/Promotion02.jpg" class="d-block w-100" alt="Promo 2">
          </div>
          <div class="carousel-item">
            <img src="images/promotion/Promotion03.jpg" class="d-block w-100" alt="Promo 3">
          </div>
        </div>
    ...
    <div class="row justify-content-center">
      <div class="col-md-3 mb-4">
        <a href="nature.html">
          <div class="card h-100 shadow">
            <img src="images/nature/homecard.jpg" class="card-img-top" alt="Nature">
      ...
      <div class="col-md-3 mb-4">
        <a href="adventure.html">
          <div class="card h-100 shadow">
            <img src="images/adventure/homecard.webp" class="card-img-top" alt="Adventure">
            <div class="card-body text-center">
      ...
      <div class="col-md-3 mb-4">
        <a href="culture.html">
          <div class="card h-100 shadow">
            <img src="images/culture/homecard.jpg" class="card-img-top" alt="Culture">
            <div class="card-body text-center">
    ...
    <div class="row">
      <div class="col-md-4 mb-4">
        <a href="service.html#hotels">
          <div class="card h-100 shadow">
            <img src="images/services/hotels.jpg" class="card-img-top" alt="Hotels">
            <div class="card-body text-center">
      ...
      <div class="col-md-4 mb-4">
        <a href="service.html#medicare">
          <div class="card h-100 shadow">
            <img src="images/services/medicare.jpg" class="card-img-top" alt="Medicare">
            <div class="card-body text-center">
      ...
      <div class="col-md-4 mb-4">
        <a href="service.html#transport">
          <div class="card h-100 shadow">
            <img src="images/services/transport.jpg" class="card-img-top" alt="Transport">
            <div class="card-body text-center">
      ...
      <div class="col-md-4 mb-4">
        <a href="service.html#tourguide">
          <div class="card h-100 shadow">
            <img src="images/services/tourguide.webp" class="card-img-top" alt="Tour Guide">
            <div class="card-body text-center">
