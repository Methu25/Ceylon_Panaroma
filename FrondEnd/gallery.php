...
<li class="nav-item ml-3">
  ...
  <section class="custom-section">
    <div class="row no-gutters align-items-center">
      ...
      <div class="col-md-6 p-5">
        ...
        <p>
          Sri Lanka is a tropical paradise filled with lush greenery, misty mountains, and pristine beaches...
        </p>
          ...
          <div id="natureCarousel" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img src="https://picsum.photos/1200/600?random=51" class="d-block w-100" alt="slide1">
              </div>
              <div class="carousel-item">
                <img src="https://picsum.photos/1200/600?random=52" class="d-block w-100" alt="slide2">
              </div>
              <div class="carousel-item">
                <img src="https://picsum.photos/1200/600?random=53" class="d-block w-100" alt="slide3">
              </div>
            </div>
  ...
  <div class="row g-0 align-items-center"> <!-- g-0 removes gutter -->
    ...
    <div class="col-md-6 p-0">
      <div class="carousel-one-side">
        <div id="adventureCarousel" class="carousel slide" data-bs-ride="carousel">
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="https://picsum.photos/1200/600?random=31" class="d-block w-100" alt="slide1">
            </div>
            <div class="carousel-item">
              <img src="https://picsum.photos/1200/600?random=32" class="d-block w-100" alt="slide2">
            </div>
            <div class="carousel-item">
              <img src="https://picsum.photos/1200/600?random=33" class="d-block w-100" alt="slide3">
            </div>
          </div>
    ...
    <!-- Description -->
    <div class="col-md-6 p-5">
      <h2 class="fw-bold">🏞️ Adventure</h2>
      <p>
